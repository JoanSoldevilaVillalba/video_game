...
#define TM_EXP_POLL 10 //this time experation limit is used for the low level impellemtnation of sending and receiving information from the client, therefor>
typedef enum {
